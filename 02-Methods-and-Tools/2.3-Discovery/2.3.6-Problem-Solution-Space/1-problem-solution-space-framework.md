...
See `2.3.6.1-Double-Diamond/1-double-diamond-guide.md` for complete process guide.
...
See `2.3.6.2-Opportunity-Solution-Tree/1-opportunity-solution-tree-guide.md` for complete guide.
...
See `2.3.6.3-Supporting-Frameworks/1-supporting-frameworks.md` for detailed methods.
