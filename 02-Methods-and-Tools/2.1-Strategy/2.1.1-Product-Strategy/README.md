...
Use these guides and templates to develop comprehensive product strategies from discovery through execution. Product strategy bridges mission/vision to actionable plans through 3-5 strategic pillars, explicit non-goals, and clear rationale.

**When to use product strategy:**
- Teams are confused about project priorities
- Debates are circular without clear direction
- Disconnect between vision and roadmap decisions
- Need to align teams around strategic choices
...
## Files
- `quickstart.md` — Abbreviated version for rapid strategy creation (8-12 weeks)
...
- **After Strategy Cycle**: Update company strategy document with new pillars
- **Quarterly Reviews**: Assess whether strategic pillars are still relevant
- **Annual Reviews**: Complete strategy refresh (typically every 1-2 years)
- **After Major Changes**: Update when market conditions or company direction significantly change
