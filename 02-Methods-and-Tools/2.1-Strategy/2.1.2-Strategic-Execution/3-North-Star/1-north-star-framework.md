...
### Step 1: Identify Your Product Game

**Purpose:** Determine which type of product game you're playing

**Activities:**
- Review product strategy and customer value proposition
- Determine if product is ATTENTION, TRANSACTION, or PRODUCTIVITY game
- Validate game type with team and stakeholders
- Document rationale for game choice

**Deliverables:**
- Product game identified (ATTENTION/TRANSACTION/PRODUCTIVITY)
- Rationale documented

**Time estimate:** 30 minutes - 1 hour

### Step 2: Brainstorm North Star Candidates

**Purpose:** Generate potential North Star metrics

**Activities:**
- Brainstorm metrics that capture customer value
- Apply criteria: customer value, measurable, actionable, connected to revenue
- Consider different time periods (daily, weekly, monthly)
- Narrow to top 2-3 candidates

**Deliverables:**
- List of North Star candidates
- Criteria assessment for each

**Time estimate:** 1-2 hours (workshop)

### Step 3: Identify Input Metrics

**Purpose:** Define leading indicators that influence North Star

**Activities:**
- For each North Star candidate, identify 3-5 input metrics
- Ensure inputs are actionable (teams can influence them)
- Map inputs to team capabilities
- Validate inputs are leading indicators

**Deliverables:**
- Input metrics for each candidate
- Team mapping

**Time estimate:** 1-2 hours (workshop)

### Step 4: Select and Define North Star

**Purpose:** Choose final North Star and define it clearly

**Activities:**
- Evaluate candidates against criteria
- Choose North Star metric
- Write clear definition (what, how measured, why it matters)
- Define measurement approach (events, IDs, dashboards)
...
### Step 5: Connect Work to North Star

**Purpose:** Link initiatives and work to input metrics

**Activities:**
- Map current initiatives to input metrics
- Ensure each initiative moves at least one input
- Document how work connects to North Star
- Create work connections section

**Deliverables:**
- Work connections documented
- Initiative-to-input mapping

**Time estimate:** 1-2 hours

### Step 6: Communicate and Operationalize

**Purpose:** Share North Star and make it operational

**Activities:**
- Communicate North Star to all teams
- Set up dashboards and tracking
- Integrate into planning processes (OKRs, roadmaps)
- Establish review cadence

**Deliverables:**
- North Star communicated
- Dashboards set up
...
### Composite North Star Metrics

**When to use:** When a single metric doesn't capture value adequately

**How it works:**
- Combine multiple metrics into composite score
- Weight metrics by importance
- Normalize metrics to same scale
- Calculate composite North Star

**Example:**
```
North Star = (0.4 × Weekly Active Users) + (0.3 × Engagement Score) + (0.3 × Revenue per User)
Result: Single metric that captures multiple dimensions of value
```

### Segmented North Stars

**When to use:** When different customer segments have different value drivers

**How it works:**
- Define North Star for each major segment
- Track segment-specific North Stars
- Aggregate to overall North Star
- Use for segment-specific prioritization

**Example:**
```
Enterprise North Star: "Weekly active enterprise teams"
SMB North Star: "Monthly active SMB teams"
Overall: Weighted average based on segment size
```

### Dynamic Input Metrics

**When to use:** When input metrics need to evolve as product matures

**How it works:**
- Start with initial set of input metrics
- Review and adjust quarterly
- Add new inputs as product evolves
- Remove inputs that no longer drive North Star

**Example:**
```
Q1: Inputs = Acquisition, Activation, Engagement
Q2: Add Retention (product matured)
Q3: Add Expansion (new capability)
Result: Inputs evolve with product maturity
```

### North Star with Guardrails

**When to use:** When optimizing North Star could harm other important metrics

**How it works:**
- Define North Star metric
- Set guardrail metrics (must not degrade)
- Monitor both North Star and guardrails
- Adjust if guardrails are at risk

**Example:**
```
North Star: "Weekly active users"
Guardrails: 
  - Customer satisfaction (must stay >4.0/5.0)
  - Revenue per user (must not decrease)
  - Churn rate (must stay <5%)
Result: Optimize North Star while protecting other metrics
```

### Predictive North Star Modeling

**When to use:** When you want to predict North Star movement

**How it works:**
- Build model predicting North Star from inputs
- Identify which inputs have strongest predictive power
- Use model to prioritize input improvements
- Validate predictions against actual results

**Example:**
```
Model: North Star = f(Input1, Input2, Input3)
Insight: Input2 has 2x predictive power of Input1
Action: Prioritize initiatives that move Input2
Result: More effective prioritization
```
