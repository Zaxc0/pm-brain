...
- **Source:** Viveck P Kumar
- **Resource:** [The Product Judgment Test](https://www.notion.so/The-Product-Judgment-Test-2e92182754b68081a535fd7f507f7b91) (Notion)
- **Note:** Forecast-before-ship calibration tracker using a **Weighted Brier Score**. The Brier score is the standard in forecasting (Glenn W. Brier, 1950); Viveck P Kumar adapted it for product work (bet type, novelty weights, outcome mapping). Used in `00-Meta/0.3-Product-Judgment-Test/`.
...
- **Note:** **Three Essential PM Senses** (Product / Execution / Analytical) referenced in self-assessment template (`6-Product-Sense-Development/templates/2-self-assessment-template.md`). **Three Levels of Work** (Impact / Execution / Optics) referenced in Work Levels mental model.
...
- **Note:** Five-question Strategic Choice Cascade for markets, positioning, and capabilities. Used in `2.1.1-Strategic-Foundations/3-Playing-To-Win/`.
...
- **Note:** Strategy kernel (diagnosis, guiding policy, coherent action) for evaluating and teaching good strategy. Used in `2.1.1-Strategic-Foundations/2-Good-Strategy-Bad-Strategy/`.
...
- **Note:** Operational process for creating strategy. Used in `2.1.1-Strategic-Foundations/1-Strategy-Blocks/`. Often combined with Playing to Win (choices) and Good Strategy Kernel (validation).
...
- **Note:** Three levels of PM work (Tactical, Operational, Strategic) by time horizon and impact. Used in `2.0.1-Mental-Models/3-Work-Levels/`.
